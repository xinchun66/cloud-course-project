...
从任务要求看，本课程设计需要完成 Docker 镜像构建、Docker Compose 本地联调、SWR 镜像推送、CCE 集群创建、kubectl 连接、Pod 与 Service 状态检查等操作；同时还需要使用 ConfigMap、Secret、PVC、LoadBalancer、HPA 等资源，并完成 Spark DataFrame、Spark SQL 和性能对比分析。
